...
#password = "ksanvwtzychnvtnu"

address = "pratikabc2@gmail.com"
password = "bwlgihppseuvbefw"
...
def options_view(request):
    ...
    if request.method == 'POST':
        ...
        if act == 'compose':
            ...
            texttospeech("Now you will be redirected back to the menu page.")
            i = i + str(1)
...
def compose_view(request):
    global i, addr, passwrd, s, item, subject, body , send , rto , to 
    if request.method == 'POST':
    ...
    if request.method == 'POST':
        ...
        while(flag):
            ...
            if act == 'unread':
                ...
                texttospeech("Now you will be redirected back to the menu page.", file+i)
                i = i + str(1)
                return JsonResponse({'result': 'logout'})
